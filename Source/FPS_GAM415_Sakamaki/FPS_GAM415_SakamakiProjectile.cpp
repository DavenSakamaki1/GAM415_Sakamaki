...
AFPS_GAM415_SakamakiProjectile::AFPS_GAM415_SakamakiProjectile() 
{
	...
	CollisionComp->OnComponentHit.AddDynamic(this, &AFPS_GAM415_SakamakiProjectile::OnHit);		// set up a notification for when this component hits something blocking
